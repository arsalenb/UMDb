...
function Movie() {
  const watchlist = [
    { key: "Watchlist_1", text: "Watchlist 1", value: "Watchlist_1" },
    { key: "Watchlist_2", text: "Watchlist 2", value: "Watchlist_2" },
    { key: "Watchlist_3", text: "Watchlist 3", value: "Watchlist_3" },
  ];
